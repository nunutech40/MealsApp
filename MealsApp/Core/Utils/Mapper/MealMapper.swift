...
final class MealMapper {
    ...
    static func mapDetailMealResponseToDomain(
        input mealResponse: MealResponse
    ) -> MealModel {
        let ingredients = IngredientMapper.mapIngredientResponseToDomains(
            by: mealResponse.id ?? "",
        ...
        return MealModel(
            id: mealResponse.id ?? "",
            title: mealResponse.title ?? "Unknown",
            image: mealResponse.image ?? "Unknown",
            category: mealResponse.category ?? "Unknown",
            area: mealResponse.area ?? "Unknown",
            instructions: (mealResponse.instructions ?? "Unknown"),
            tag: mealResponse.tag ?? "Unknown",
            youtube: mealResponse.youtube ?? "Unknown",
            source: mealResponse.source ?? "Unknown",
            ingredients: ingredients,
            favorite: false
        )
    }
